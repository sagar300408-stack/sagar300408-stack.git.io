    ...
    <div className="h-screen flex bg-bg-secondary overflow-hidden">
      ...
      <aside className="w-64 bg-surface border-r border-border flex flex-col flex-shrink-0 z-20">
        ...
        <div className="h-16 px-6 flex items-center border-b border-border">
          <span className="font-serif font-semibold text-xl text-text-primary tracking-tight">Originyx</span>
        </div>
        ...
        <div className="p-4 border-t border-border">
          <div className="flex items-center gap-3 mb-3 px-1">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-text-primary truncate">{user?.user_metadata?.full_name || 'Client'}</p>
